        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mb-lg-0 ms-auto fw-semibold ">
                ...
                <li class="nav-item dropdown my-auto me-2">
                    <a class="nav-link font-weight-bold dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="modules">
                        Modules
                    </a>
                ...
                <li class="nav-item me-5">
                    <a class="nav-link font-weight-bold active ms-lg-3 " href="messanger"><i class="bi bi-chat-dots-fill position-relative"><span class="text-danger" style="font-size: 14px;position: absolute;top:-35%;right:-29%"><?php if (isset($_SESSION['nbr_Messages_NSeen']) and $_SESSION['nbr_Messages_NSeen'] != 0) {
                                                                                                                                                                                                                                            echo $_SESSION['nbr_Messages_NSeen'];
                                                                                                                                                                                                                                        } ?></span></i></a>
                </li>

                <?php if ($_SESSION['user_info']['statut'] == 3) { ?>
                    <li class="nav-item dropdown profile mx-lg-3">
                ...
                <li class="nav-item dropdown my-auto">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <form class="dropdown-item" method="post"><button type="submit" name="logout" class="border-0 mt-2" style="background-color:inherit" title="deconexion">log out</button></form>
                        </li>
                    </ul>
                </li>
            </ul>
