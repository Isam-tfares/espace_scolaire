...
class CourController
{
    ...
    {
        if (isset($_POST['ajouterCour']) && isset($_POST['name']) && isset($_POST['module']) && isset($_FILES['file']) && isset($_SESSION['prof_id']) && !empty($_FILES['file']['name']) && !empty($_POST['name'])) {
            ...
            if (ModuleController::isHereModule($_POST['module'])) {
                ...
                Redirect::withPost('module', $_POST['module'], "Il y'a u probleme Essayez de retélécharger votre fichier");
            }
        }
        Redirect::withPost('module', $_POST['module'], "Il y'a u probleme Essayez de vérifier les champs du formule");
    }
